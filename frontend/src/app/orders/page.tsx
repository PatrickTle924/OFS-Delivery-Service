...
const ORDERS = [
  {
    ...
    weight: "8.2 lbs",
    status: "In Transit",
    placedAt: "2:15 PM - March 4th, 2026",
    address: "123 Main St, San Jose, CA 95124",
    eta: "2:45 PM",
    steps: [
      { label: "Order Placed", time: "1:15 PM", done: true, active: false },
      { label: "Order Confirmed", time: "1:20 PM", done: true, active: false },
      { label: "Out for Delivery", time: "2:00 PM", done: false, active: true },
      { label: "Delivered", time: "Est. 2:45 PM", done: false, active: false },
    ],
  },
  {
    id: 12346,
    ...
    weight: "10.1 lbs",
    status: "In Transit",
    placedAt: "3:05 PM - March 4th, 2026",
    address: "456 Oak Ave, San Jose, CA 95112",
    eta: "3:30 PM",
    steps: [
      { label: "Order Placed", time: "2:10 PM", done: true, active: false },
      { label: "Order Confirmed", time: "2:18 PM", done: true, active: false },
      { label: "Out for Delivery", time: "3:00 PM", done: false, active: true },
      { label: "Delivered", time: "Est. 3:30 PM", done: false, active: false },
    ],
  },
];
...
function TimelineStep({ step }: { step: { label: string; time: string; done: boolean; active: boolean } }) {
    ...
    <div className="rounded-3xl border border-warm bg-white/70 p-6 shadow-sm backdrop-blur-sm md:p-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.8fr_1fr]">
        ...
        <div className="rounded-2xl border border-warm/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.5),rgba(246,241,233,0.7))] p-3">
          <div className="flex h-[260px] items-center justify-center rounded-xl border border-dashed border-forest/15 bg-forest/5 text-3xl text-forest/45 md:h-[340px]">
            Map
          </div>
        </div>
