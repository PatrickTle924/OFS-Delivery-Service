  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-cream relative">
      ...
      <section className="relative min-h-screen flex flex-col justify-center px-8 pt-32 pb-20 max-w-7xl mx-auto">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-lg text-[#3a3a30] font-light leading-relaxed max-w-lg mb-12">
            ...
            — powered by smart routing, real-time tracking, and a seamless
            checkout experience.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-5">
            ...
            >
              ...
              <span className="w-7 h-7 rounded-full border-[1.5px] border-forest/30 flex items-center justify-center group-hover:border-forest group-hover:bg-forest/5 transition-all duration-200">
                →
              </span>
            </Link>
          </div>
      ...
      <div className="bg-forest overflow-hidden py-4 relative">
        ...
        <div className="flex gap-12 animate-marquee whitespace-nowrap w-max relative z-10">
          {[...MARQUEE_ITEMS, ...MARQUEE_ITEMS].map((item, i) => (
            <span
              key={i}
              className="text-mint/80 text-xs font-medium tracking-[0.14em] uppercase"
            >
      ...
      >
        ...
        <p className="text-sage text-xs font-medium tracking-[0.14em] uppercase mb-3">
          Simple Process
        </p>
        <h2 className="font-playfair text-4xl md:text-5xl text-forest leading-tight mb-16">
          From cart to <em className="text-clay">doorstep</em>
          <br />
          in three steps
        </h2>
          ...
          {STEPS.map((step) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-forest font-medium text-xl mb-3">
                  {step.title}
                </h3>
                <p className="text-[#4a4a3a] text-sm font-light leading-relaxed">
                  {step.desc}
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {FEATURES.map((f) => (
            ...
            >
              ...
              <div
                className={`w-12 h-12 rounded-2xl ${f.iconBg} flex items-center justify-center shrink-0 shadow-md text-cream`}
              >
                {f.icon}
              </div>
              <div className="relative z-10">
                <h3 className="text-forest font-medium text-base mb-1.5">
                  {f.title}
                </h3>
      ...
      <div className="mx-8 mb-28 relative rounded-3xl overflow-hidden">
        ...
        <div className="relative z-10 px-10 py-24 text-center text-cream">
          <p className="text-mint/70 text-xs font-medium tracking-[0.16em] uppercase mb-4">
            Start today
          </p>
          ...
          <p className="text-cream/60 max-w-md mx-auto mb-12 font-light leading-relaxed text-base">
            Join OFS today and get organic groceries delivered right to your
            door — fast, fresh, and tracked every step of the way.
          </p>
          <Link
            href="/login-register"
      ...
      <footer className="bg-darkbg text-[#a0b8a6]/60 py-10 text-center text-sm relative overflow-hidden">
        ...
        <p className="relative z-10">
          © 2025 <span className="font-playfair text-cream">OFS</span> — Organic
          Food Service, San Jose, CA. All rights reserved.
        </p>
      </footer>
    </main>
  );
